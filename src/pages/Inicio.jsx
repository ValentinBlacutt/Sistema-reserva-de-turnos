  ...
  return (
    <div className="container mt-5">
      <div className="row mb-5">
        <div className="col">
          <h1 className="fw-bold text-pastel-dark mb-2">Bienvenido al Panel de Control</h1>
          <p className="text-muted fs-5">Seleccione un módulo para gestionar las reservas y turnos del sistema.</p>
        </div>
      </div>

      /* Sección de tarjetas de módulos */
      <div className="row g-4">
        
        /* Tarjeta 1: ABM de Profesionales */
        <div className="col-12 col-md-6">
          <div className="card custom-card h-100 p-4 shadow-sm">
            <div className="card-body d-flex flex-column justify-content-between">
              <div>
                <div className="d-flex align-items-center mb-3">
                  <div className="p-3 rounded bg-light me-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#9DB2BF" className="bi bi-calendar3" viewBox="0 0 10 16">
              ...
              <button className="btn btn-secondary w-100 py-2 border-0 opacity-75" disabled style={{ backgroundColor: '#DDE6ED', color: '#27374D' }}>
